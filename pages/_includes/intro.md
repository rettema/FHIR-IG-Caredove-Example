...
###  Caredove API Library

The Caredove APIs are used to support connecting referral and client/patient referral information to external systems, such as EMRs/EHRs & Case Management systems.

The APIs support two main use processes:

- Sending a new referral to Caredove
- Receiving referral information from Caredove which includes
  - The provider retreiving a new referral
  - The provider or sender retreiving information and updates about a referral
<p></p>
<p></p>

```
#### Jekyll Site Variables (Debug Information)
